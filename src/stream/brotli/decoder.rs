...
/// A brotli decoder, or compressor.
///
...
pub struct BrotliDecoder<S: Stream<Item = Result<Bytes>>> {
    #[pin]
    inner: crate::stream::generic::Decoder<S, crate::codec::BrotliDecoder>,
}
...
impl<S: Stream<Item = Result<Bytes>>> BrotliDecoder<S> {
    ...
    pub fn new(stream: S) -> Self {
        Self {
            inner: crate::stream::generic::Decoder::new(stream, crate::codec::BrotliDecoder::new()),
        }
    }
