        ...
        mod $variant {
            ...
            mod stream {
                mod compress {
                    ...
                    fn with_level_0() {
                        ...
                        let encoder =
                            stream::Encoder::with_quality(input.stream(), Level::Precise(0));
            ...
            mod futures_io {
                mod bufread {
                    ...
                    mod decompress {
                        ...
                        fn short_chunks() {
                            ...
                            let input = InputStream::from(Vec::from_iter(
                                compressed.chunks(2).map(Vec::from),
                            ));
                            let output = bufread::decompress(bufread::from(&input));
                ...
                mod write {
                    mod compress {
                        use crate::utils::{
                            algos::$variant::{futures_io::write, sync},
                            FromIterator, InputStream, Level,
                        };
            ...
            mod tokio_02 {
                ...
                mod write {
                    mod compress {
                        use crate::utils::{
                            algos::$variant::{sync, tokio_02::write},
                            FromIterator, InputStream, Level,
                        };
