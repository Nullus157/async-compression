...
- Enforce `WriteBuffer::advance` and `WriteBuffer::written` initialization checks in release builds to prevent safe access to uninitialized memory ([#474](https://github.com/Nullus157/async-compression/issues/474)).
